...
+ (void)showHUDWithText:(NSString *)text
{
    ...
    [Tool showWarning:[UIApplication sharedApplication].keyWindow mText:text seconds:2.0 callback:nil];
}

+ (void)showHUDWithText:(NSString *)text callback:(void(^)(void))callback
{
    [Tool showWarning:[UIApplication sharedApplication].keyWindow mText:text seconds:2.0 callback:callback];
}
