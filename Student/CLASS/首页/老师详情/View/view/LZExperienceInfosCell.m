...
@implementation LZExperienceInfosCell
...
- (void)setModel:(ContentModel *)model {
    _model = model;
    _timeTitle.text = model.timeTitle;
...
-(void)drawLine{
    ...
    [shapeLayer setStrokeColor:UICOLOR_RGB_Alpha(0xdbdbdb, 1).CGColor];
